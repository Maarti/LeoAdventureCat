...
public class ApplicationController : MonoBehaviour
{
	...
	void initLevels ()
	{
        ...
        Dictionary<LevelEnum, Level> lvls = new Dictionary<LevelEnum, Level>
        {
            ...
            { LevelEnum.level_2_story, new Level(LevelEnum.level_2_story, "2-", WorldEnum.AnimalPound, DifficultyEnum.MEDIUM, 25, 320, 5, LevelEnum.level_2_01, false, true) },
            { LevelEnum.level_2_01, new Level(LevelEnum.level_2_01, "2-01", WorldEnum.AnimalPound, DifficultyEnum.EASY, 10, 80, 2, LevelEnum.level_2_02, false) },
