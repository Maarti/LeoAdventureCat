...
public class ApplicationController : MonoBehaviour
{
	...
	void initLevels ()
	{
		...
		lvls.Add (LevelEnum.level_2_story, new Level (LevelEnum.level_2_story, "2-", WorldEnum.AnimalPound, DifficultyEnum.MEDIUM, 25, 235, 5, LevelEnum.level_1_01, false, true));
		this.levels = lvls;
	}
